...
import {
  ...
  Star, Moon, Sun, Settings, Loader2, Clock, Database, Eye, Flame, PieChart, Calendar, Target, Shield, Banknote, Brain, FolderSearch, CalendarClock, EyeOff, Grid3X3, ArrowDownUp, ThumbsUp, FileSearch, Sparkles, BookOpen, Map, Calculator, SlidersHorizontal, BarChartHorizontal,
} from 'lucide-react';
