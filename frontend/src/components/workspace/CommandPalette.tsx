...
import {
  ...
  Star, Moon, Sun, Settings, Loader2, Clock, Database, Eye, Flame, PieChart, Calendar, Target, Shield, Banknote, Brain, FolderSearch, CalendarClock, EyeOff, Grid3X3, ArrowDownUp, ThumbsUp, FileSearch, Sparkles, BookOpen, Map, Calculator, SlidersHorizontal, BarChartHorizontal, Activity,
} from 'lucide-react';
...
export function CommandPalette({ open, onClose }: CommandPaletteProps) {
  ...
  const pages: CommandItem[] = [
    ...
    { id: 'bonds', label: 'Bonds & Fixed Income', description: 'Treasuries, yield curve, spreads', icon: <Banknote className="h-4 w-4" />, action: () => go('/bonds', 'Bonds'), category: 'Pages' },
    ...
    { id: 'filings', label: 'SEC Filings', description: '10-K, 10-Q, 8-K, proxy statements', icon: <FileSearch className="h-4 w-4" />, action: () => go('/filings', 'SEC Filings'), category: 'Pages' },
    ...
    { id: 'estimates', label: 'Earnings Estimates', description: 'EPS & revenue consensus estimates', icon: <BarChartHorizontal className="h-4 w-4" />, action: () => go('/estimates', 'Estimates'), category: 'Pages' },
    ...
    { id: 'debt-monitor', label: 'Debt Monitor', description: 'Government & corporate debt tracking', icon: <CreditCard className="h-4 w-4" />, action: () => go('/debt-monitor', 'Debt Monitor'), category: 'Pages' },
    ...
    { id: 'fund-flows', label: 'Fund Flows', description: 'ETF inflows, outflows, sector trends', icon: <ArrowDownUp className="h-4 w-4" />, action: () => go('/fund-flows', 'Fund Flows'), category: 'Pages' },
