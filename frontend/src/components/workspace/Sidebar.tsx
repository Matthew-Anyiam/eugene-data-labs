...
import {
  Search, Globe, BarChart3, TrendingUp, LineChart, Bitcoin, GitCompareArrows, Bot, Briefcase, Bell, Newspaper, FileBarChart, LayoutGrid, UserCheck, CalendarDays, Rocket, CircleDollarSign, Layers, ArrowLeftRight, Gem,
  Network, LayoutDashboard, FileText, ChevronDown, ChevronRight,
  Moon, Sun, Star, Plus, CreditCard, Zap, X, Activity, Settings, Eye, Calendar, BookOpen, Calculator,
} from 'lucide-react';
